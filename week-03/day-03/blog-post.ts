...
class BlogPost{
  ...
  showMyBlogPost(): void {
    console.log(`"${this.title}" by ${this.authorName} posted at ${this.publicationDate}:\n\t${this.text}`)
  }
}

const firstPost: BlogPost = new BlogPost('John Doe', 'Lorem Ipsum', 'Lorem ipsum dolor sit amet.', '2000.05.04.');
const secondPost: BlogPost = new BlogPost('Tim Urban', 'Wait but why', 'A popular long-form, stick-figure-illustrated blog about almost everything.', '2010.10.10.');
...
firstPost.showMyBlogPost();
secondPost.showMyBlogPost();
thirdPost.showMyBlogPost();